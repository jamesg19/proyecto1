...
public class Reporte2 extends javax.swing.JFrame {
     ...
     * @param CODIGOTIENDA
     */                 
    public Reporte2(String CODIGOTIENDA) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("TlwgTypewriter", 3, 20)); // NOI18N
        jLabel1.setText("estar en la tienda pero debe verificarse su ingreso.");

        jLabel3.setFont(new java.awt.Font("TlwgTypewriter", 3, 24)); // NOI18N
        jLabel3.setText("Pedidos que estan en tiempo de ");
     ...
     */
    private void buscar() {
        String query = "SELECT distinctrow cod_cliente,tienda_origen,tienda_destino,fecha,cod_articulo,cantidad,total,dias_espera,codigo_pedido FROM pedido p INNER JOIN tiempo_entre_tiendas t ON p.tienda_destino=t.destino and p.tienda_destino= ?   ";
